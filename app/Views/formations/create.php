...
<form action="<?= base_url('formations/store') ?>" method="post">
...
<label>Niveau</label>
<input type="text" name="niveau" placeholder="Ex : Licence, Master..." required>

<label>Description</label>
<textarea name="description"></textarea>

<div class="actions">
<a href="<?= base_url('formations') ?>">← Retour</a>
